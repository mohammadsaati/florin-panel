...
return [
    /*
    |--------------------------------------------------------------------------
    | پیام‌های اعتبارسنجی شماره تلفن
    |--------------------------------------------------------------------------
    |
    | پیام‌های سفارشی برای اعتبارسنجی شماره تلفن با استفاده از پکیج Laravel-Phone
    |
    */
    ...
    'required_with' => 'تکمیل گزینه :attribute زمانی که مقدار :values است الزامی است',
    ...
    'uploaded' => 'حجم فایل مورد نظر بیش از حد مجاز است.',
    ...
    */
    ...
    'custom' => [
        ...
        'files' => [
            'max' => 'حجم فایل مورد نظر بیش از ۱۵ مگابایت است.',
            'uploaded' => 'حجم فایل مورد نظر بیش از ۱۵ مگابایت است.',
        ],
        'files.*' => [
            'max' => 'حجم فایل مورد نظر بیش از ۱۵ مگابایت است.',
            'uploaded' => 'حجم فایل مورد نظر بیش از ۱۵ مگابایت است.',
    ...
    */
    ...
    'attributes' => [
        ...
        'mobile_code' => 'شماره موبایل',
        'country_code' => 'کد کشور',
        'phone_number' => 'شماره تلفن',
        'code' => 'کد تایید',
        'subject' => 'موضوع',
        'category' => 'نوع پشتیبانی',
        'head_number_id' => 'خط',
        'message' => 'متن پیام',
        'slug' => 'کلمه کلیدی',
        'amount' => 'مبلغ',
        ...
        'durations' => 'مدت زمان',
        'currency' => 'اعتبار',
        'credentials.mode' => 'حالت درگاه',
        'excel' => 'اکسل',
        'status' => 'وضعیت',
        'plan_id' => 'اشتراک',
        'card_number_reason' => 'دلیل رد شماره کارت',
        'national_card_image_reason' => 'دلیل رد عکس کارت ملی',
        'card_number' => 'شماره کارت',
        'national_card_image' => 'عکس کارت ملی',
        'scheduled_at' => 'تاریخ ارسال ',
        'send_time'=> 'زمان ارسال',
        'terms' => 'قوانین',
        'legal_type' => 'نوع کاربری',
        'birthdate' => 'تاریخ تولد',
        'national_id' => 'کد ملی',
        'company_name' => 'نام شرکت',
        'company_register_number' => 'شماره ثبت شرکت',
        'company_national_id' => 'شماره ملی شرکت',
        'postal_code' => 'کد پستی',
        'numbers' => 'شماره های ارسال',
        'phonebook_id' => 'دفترچه تلفن',
        'file_id' => 'فایل',
        'pattern' => 'پترن (اسلاگ)',
        'variables' => 'متغیرها',
        'recipient' => 'شماره گیرنده',
        'recipients' => 'شماره گیرنده‌ها',
        'sourceNumber' => 'سرشماره',
        'variables.*.name' => 'نام متغیر',
        'variables.*.type' => 'نوع متغیر',
        'variables.*.size' => 'حداکثر تعداد کاراکتر متغیر',
        'variables.*.required' => 'الزامی بودن متغیر',
        'head_number_ids' => 'خطوط پیامکی',
        'uids' => 'شناسه های یکتای پیامک',
        'template' => 'قالب',
        'prenumber_gender' => ' فیلتر های پیش شماره جنسیت',
        'postal_codes_gender' => ' فیلتر های جستجو',
        'postal_codes.*.female_from' => 'بازه زنان وارد نشده است یا نامعتبر است',
        'postal_codes.*.male_from' => 'بازه مردان وارد نشده یا نامعتبر است',
        'general_area' => 'های تمام موارد ',
        'area_prenumber' => 'های تمام موارد',
        'area_prenumber.*.total_mci_from' => 'از ',
        'area_prenumber.*.total_mci_count' => 'تا',
        'postal_codes.*.ir_count' => 'تا ایرانسل',
        'postal_codes.*.ir_from' => 'از',
        'postal_codes.*.mci_from' => 'از',
        'postal_codes.*.mci_count' => 'تا همراه اول',
        'jobs' => 'های تمام موارد',
        'neighborhood' => 'های تمام موارد',
    ...
    */
    ...
    'phone' => 'فیلد :attribute باید شماره تلفن معتبر باشد.',
    'phone_country' => 'فیلد :attribute باید شماره تلفن معتبر برای کشور مشخص شده باشد.',
    'phone_international' => 'فیلد :attribute باید شماره تلفن بین‌المللی معتبر باشد.',
    'phone_sms_iran' => 'ارسال پیامک فقط برای شماره‌های موبایل ایران امکان‌پذیر است.',
    'phone_mobile_only' => 'فیلد :attribute باید شماره موبایل باشد.',
    'captcha' => 'کپچا نامعتبر است.',
